...
<header class="flex flex-col md:flex-row justify-between items-center p-3 md:p-4 md:px-6 bg-background border-b-2 border-border flex-shrink-0 gap-4 md:gap-0">
  <div class="text-center md:text-left">
    <div class="flex items-center justify-center gap-2 md:justify-start mb-2">
      ...
      variant="outline"
      size="sm"
      onclick={() => window.open('https://github.com/reacheight/asd.lol', '_blank')}
    >
      ...
      <span class="text-secondary-foreground tracking-tight">3 (me, myself & i)</span>
    </Button>
    </div>
    <p class="mt-1 mb-0 text-sm text-muted-foreground font-medium">your second stimulation-addicted brain</p>
  </div>
